...
export function EdificioForm({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1 sm:col-span-2">
        <label className="text-xs font-medium text-stone-600 dark:text-stone-400">Dirección</label>
        <input
          type="text"
          name="direccion"
      ...
      <div className="flex flex-col gap-1">
        <label className="text-xs font-medium text-stone-600 dark:text-stone-400">Ciudad</label>
        <input
          type="text"
          name="ciudad"
      ...
      <div className="flex flex-col gap-1">
        <label className="text-xs font-medium text-stone-600 dark:text-stone-400">País</label>
        <input
          type="text"
          name="pais"
