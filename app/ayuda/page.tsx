...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    parrafos: [
      ...
      "Las alertas rojas y amarillas avisan de: obligaciones vencidas o próximas a vencer, unidades ocupadas sin un ingreso de renta registrado este mes (recordatorio de lo que falta por cobrar), un inquilino en particular que ya lleva más de 7 días de atraso sobre su fecha esperada de pago, y contratos que cumplen un año y deben renovarse ajustando el canon por inflación.",
    ],
