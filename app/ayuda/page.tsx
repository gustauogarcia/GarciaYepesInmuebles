...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    parrafos: [
      ...
      "Las alertas avisan de: obligaciones vencidas o próximas a vencer, unidades ocupadas sin un ingreso de renta registrado este mes (recordatorio de lo que falta por cobrar), un inquilino en mora (renta pagada hasta una fecha anterior a hoy — roja si son 15 días o más, amarilla si es menos), y contratos que cumplen un año y deben renovarse ajustando el canon por inflación.",
      "Cómo se calcula la mora: la app toma el último ingreso de categoría \"Renta\" registrado para cada unidad (sin importar el monto exacto, se asume que cubre un mes completo) y calcula hasta qué fecha queda pagada la renta desde ese pago (\"pagado hasta\"), usando siempre el día de aniversario del contrato como referencia. Esa fecha se compara contra el día de hoy, así que si todavía no has registrado el pago (o cualquier otro movimiento reciente) de una unidad, la alerta va a aparecer como recordatorio para que pongas Movimientos al día — es intencional: sirve para motivar a capturar la información a tiempo, no solo para avisar de inquilinos realmente atrasados. Por eso, si alguna vez recibes un pago único que en realidad cubre dos o tres meses atrasados, regístralo como dos o tres movimientos de Renta separados (puedes usar la misma fecha en los tres) — si lo dejas como un solo movimiento, la app solo lo va a contar como un mes cubierto.",
    ],
