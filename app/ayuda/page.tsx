...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    parrafos: [
      ...
      "Cómo se calcula la mora: la app cuenta cada ingreso de categoría \"Renta\" registrado para una unidad como si cubriera un mes completo, y así calcula hasta qué fecha quedó pagada la renta de cada inquilino (\"pagado hasta\"). Si esa fecha ya pasó, aparece la alerta. Por eso, si alguna vez recibes un pago único que en realidad cubre dos o tres meses atrasados, regístralo como dos o tres movimientos de Renta separados (puedes usar la misma fecha en los tres) — si lo dejas como un solo movimiento, la app solo lo va a contar como un mes cubierto.",
    ],
