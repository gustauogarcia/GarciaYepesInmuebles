...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    parrafos: [
      ...
      "Las alertas rojas y amarillas avisan de: obligaciones vencidas o próximas a vencer, un inquilino atrasado en el pago de renta de este mes (más de 7 días después de su fecha esperada), unidades ocupadas sin un ingreso de renta registrado este mes y sin un inquilino activo identificable, y contratos que cumplen un año y deben renovarse ajustando el canon por inflación.",
    ],
